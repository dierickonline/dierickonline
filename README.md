...
🤖 **Current Focus**: Mastering AI-native development workflows and currently preparing for the 
Claude Certified Architect (Foundation) to integrate advanced LLM reasoning into professional software lifecycles.
...
### 📈 Trading Platform — Interactive Brokers ([Public Repo](https://github.com/dierickonline/TradingApp))
